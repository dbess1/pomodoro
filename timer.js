...
//2. when reducing either one of the timers from 25 and 5, resepectively,
//then pressing Restart, each timer goes back to 25 and 5, respectively,
...
//-------this is the end of that timer preference section---------------//
    ...
    if (paused == false) {
      function startTimer(duration, display) {
        ...
        var startTime = setInterval(function() {
          ...
          seconds = parseInt(timer % 60, 10); //eliminate decimals 
